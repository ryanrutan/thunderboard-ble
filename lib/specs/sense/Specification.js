...
spec["services"][tb.Service.Key.Environment]["characteristics"][tb.Characteristic.Key.AmbientLight] = {
  "uuid" : tb.Characteristic.Uuid.AmbientLight,
  "name" : tb.Characteristic.Key.AmbientLight,
  "label" : "Ambient Light",
  "readonly" : true
};
spec["services"][tb.Service.Key.Environment]["characteristics"][tb.Characteristic.Key.Pressure] = {
  "uuid" : tb.Characteristic.Uuid.Pressure,
  "name" : tb.Characteristic.Key.Pressure,
  "label" : "Barometric Pressure",
  "readonly" : true
};
spec["services"][tb.Service.Key.Environment]["characteristics"][tb.Characteristic.Key.Microphone] = {
  "uuid" : tb.Characteristic.Uuid.Microphone,
  "name" : tb.Characteristic.Key.Microphone,
  "label" : "MEMS Microphone",
  "readonly" : true
};
